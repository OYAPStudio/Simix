...
export default function LiquidGlassStats({ 
  ...
  return (
    <section className="relative pb-24 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 min-h-screen overflow-hidden" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 ${hasTopBlur ? 'pt-32' : 'pt-24'} ${hasBottomBlur ? 'pb-32' : 'pb-24'}`}>
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-center">
            <span className="text-gray-900 dark:text-white">{t('stats.header.trusted')}</span> <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-300 dark:via-purple-300 dark:to-pink-300 bg-clip-text text-transparent">{t('stats.header.leaders')}</span>
          </h2>
